...
- Buildings unlock their unit permanently. Resource cost is `base resource cost × next building level`, plus `20 × current building level` Gold; building levels cannot exceed the Castle. Each level after the first adds 30% of the unit's base HP and damage.
