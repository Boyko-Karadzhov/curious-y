...
**Try it:** Start Explorer Demo, answer a Physics question, visit Castle, spend 10 Force to build Barracks, then start Battle 1-1 and watch Swordsmen spawn and fight on their own. You can return to learning while the battle runs. No API key is needed for this loop. Demo questions and scripted tutor replies are visibly labeled. Live generation requires Google sign-in and a Gemini key saved in Settings; these controls are disabled and marked unavailable in Explorer Demo.
