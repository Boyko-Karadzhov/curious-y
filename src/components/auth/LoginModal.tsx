        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-900 via-indigo-950 to-slate-900 text-white flex flex-col justify-between selection:bg-brand-500 selection:text-white">
            ...
            ?Y
                ...
                <div className="text-xs text-slate-400 font-medium hidden sm:flex items-center gap-1.5">
                    ...
                    <span>{isLocal ? 'Local Supabase development' : 'Secure Google OAuth & Supabase backend'}</span>
                </div>
            </div>
            ...
            Curious-Y quizzes you on the intuition behind scientific, mathematical, and historical concepts, then lets you explore them with a Gemini tutor.
                ...
                ?
                            ...
                            <p className="text-xs text-slate-300">
                                {isLocal
                                    ? 'Create a local account or sign in to test your backend.'
                  ...
                  Or
                            ...
                            >
                                <span>Try Explorer Demo (No account required)</span>
