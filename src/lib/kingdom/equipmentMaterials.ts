...
const militiaIdle = region([105,139,127,144,149,140,155,161,98,162], [75,189,103,187,117,211,84,210], [183,164,206,159,221,198,189,204]);
const spearmanIdle = region([121,173,136,176,138,187,119,192], [165,184,192,180,187,192,163,195]);
const royalGuardIdle = region([92,141,136,148,133,173,91,163], [65,194,97,189,112,217,77,230]);
const championIdle = region([124,174,138,176,142,190,130,195,122,184], [132,196,173,220,171,224,129,199]);
...
export const IDENTITY_MATERIALS: Readonly<Record<string, Rig>> = {
    militia: rig(militiaIdle,[militiaIdle,militiaIdle,
        region([115,139,136,148,153,145,160,159,122,167], [125,164,152,174,142,199,119,198], [196,155,218,158,230,188,195,193]),
        region([110,139,132,147,153,146,158,162,111,163], ...militiaIdle.weapon),
    ],[
    ...
    'royal-guard': rig(royalGuardIdle,[royalGuardIdle,royalGuardIdle,royalGuardIdle,royalGuardIdle],[
    ...
    champion: rig(championIdle,[championIdle,championIdle,championIdle,championIdle],[
        championIdle,
    ...
    'marksman': rig(gunnerIdle,[gunnerIdle,gunnerIdle,gunnerIdle,gunnerIdle],[
    ...
    'acolyte': rig(frostIdle,[frostIdle,frostIdle,frostIdle,frostIdle],[
        frostIdle,
    ...
    'priest': rig(sageIdle,[sageIdle,sageIdle,sageIdle,sageIdle],[
        sageIdle,
