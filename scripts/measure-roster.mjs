...
console.table(results);writeFileSync('docs/roster-balance.json',JSON.stringify({investment:'Keep 3; all recruitment buildings 3; each of four equipped units level 2/star 1; no towers/Library. Unit upgrade investment 80 Gold + 35 total Resources, with topic distributions varying by build. Stage 21 Keep HP; enemy building stats 3, one recruit every 8s.',results},null,2)+'\n');
