...
export const UNIT_CLASSES = [
    {
        ...
        name: 'Melee',
        building: 'barracks',
        description: '+50% damage to swarm; −25% to ranged.'
    },
    {
        id: 'ranged',
        name: 'Ranged',
        building: 'range',
        description: '+50% damage to melee; −25% to swarm.'
    },
    {
        id: 'swarm',
        name: 'Swarm',
        building: 'stable',
        description: 'Five creatures per deployment. Strong against single targets; vulnerable to siege splash.'
    },
    {
        id: 'healer',
        name: 'Healer',
    ...
    },
    {
        ...
        name: 'Siege',
        building: 'workshop',
        description: 'Triple Keep damage; −25% damage to all unit classes. Splash hits up to five nearby enemies.'
    },
] as const;
...
const profiles: Record<UnitClass, { hp: number; damage: number; healing: number; range: number; speed: number; spawnInterval: number; castleMultiplier: number; tags: string[]; ability: AbilityDefinition; color: string }> = {
    melee: {
        ...
        ability: {
            ...
            interval:1,
            armor:.04,
            description:'Guard: +4 percentage points of armor. +50% damage to swarm; −25% to ranged.'
        }
    },
    ranged: {
        hp: 32,
        ...
        ability: {
            ...
            interval:1.25,
            armor:0,
            description:'Volley: +50% damage to melee; −25% to swarm.'
        }
    },
    swarm: {
        hp: 16,
        ...
        ability: {
            ...
            interval:1.25,
            armor:0,
            description:'Brood: five small creatures per deployment, sharing one capacity point. Overwhelms single targets; vulnerable to splash.'
        }
    },
    healer: {
        hp: 30,
        ...
        ability: {
            family:'heal',
            interval:1,
            description:'Mend: heals one injured ally with a finite lifetime budget. Cannot attack, resurrect, heal other healers or heal Keeps.'
        }
    },
    siege: {
        hp: 55,
        ...
        ability: {
            ...
            fraction:.35,
            targets:5,
            description:'Siege: triple Keep damage; −25% damage to all unit classes. 35% splash to five nearby enemies.'
        }
    },
};
