...
const subjects: Record<string, {
    ...
    Life: {
        ...
        seeds: [
            ['food-fuel', 'Food as fuel', 'Food contains chemical energy. Cells transfer some of that energy to processes such as movement, growth, and repair; food also supplies building materials.'],
            ['cells', 'Cells: living building blocks', 'A cell is a small unit of life enclosed by a membrane. Human bodies contain many cells that exchange materials with their surroundings and perform different jobs.'],
            ['stores', 'Saving fuel for later', 'The body stores some fuel after eating and releases stored fuel between meals. A store grows when more enters than leaves and shrinks when more leaves than enters.'],
            ['feedback', 'Keeping conditions steady', 'Negative feedback means a change triggers a response that opposes that change. In bodies, cells respond to information about changing conditions. Regulation keeps conditions within a range, not perfectly constant.'],
        ],
    },
    Physics: {
        ...
        seeds: [
            ['motion', 'Describing motion', 'Speed describes how far an object travels per unit time. Direction also matters when describing velocity. Motion is described relative to a reference point.'],
            ['pushes', 'Pushes and pulls', 'A force is a push or pull from an interaction. Forces can change motion or deform objects. Multiple forces can balance.'],
            ['inertia', 'Continuing in motion', 'With no net external force, an object keeps a constant velocity. A force is needed to change motion, not to maintain a constant velocity.'],
            ['resistance', 'What slows things down', 'Friction and drag oppose relative motion. They transfer energy from organized motion into other forms, including thermal energy.'],
        ],
    },
    'Mathematics & Logic': {
        ...
        seeds: [
            ...
            ['all', 'What “every” means', 'A universal claim says a property holds for every member of a specified set. A single member without that property makes the universal claim false.'],
            ['proof', 'Evidence and proof', 'A mathematical proof establishes a claim from stated assumptions using valid reasoning. Checking several examples is not generally a proof of a universal claim.'],
        ],
    },
    Chemistry: {
        ...
        seeds: [
            ...
            ['states', 'Solid, liquid, and gas', 'In a gas, particles are much farther apart and move freely compared with a liquid. Evaporation changes water from liquid to gas without changing its molecular identity.'],
            ['conservation', 'Tracking matter', 'Mass is conserved in ordinary physical changes in a closed system. In an open container, matter can leave and enter, changing the mass inside.'],
        ],
    },
    'Computer Science': {
        ...
        seeds: [
            ...
            ['conditions', 'Decisions in a program', 'A conditional instruction selects an action based on whether a specified condition holds. Its behavior depends on the exact condition and input.'],
            ['testing', 'Checking a solution', 'Testing compares a program’s actual output with expected behavior for chosen inputs. A passing example does not establish correctness for every possible input.'],
        ],
    },
    'Earth & Space': {
        ...
        seeds: [
            ...
            ['rotation', 'A turning Earth', 'Earth rotates about its axis roughly once per day. A location moves with Earth as the planet turns.'],
            ['daylight', 'The sunlit side', 'About half of Earth faces the Sun at a time. Rotation carries most places between illuminated and dark regions; polar regions have seasonal exceptions.'],
        ],
    },
    'Mind & Behavior': {
        ...
        seeds: [
            ...
            ['reconstruction', 'Putting memories together', 'Remembering can combine stored information with current knowledge and expectations. This can help interpretation but can also introduce errors.'],
            ['checking', 'Checking a recollection', 'Confidence and accuracy are different. Independent records and carefully designed comparisons can help test whether a remembered detail is accurate.'],
        ],
    },
    'Society & History': {
        ...
        seeds: [
            ...
            ['context', 'Putting a source in context', 'Who produced a source, when, for whom, and for what purpose affects how it can be interpreted. Context helps assess what a source can establish.'],
            ['corroboration', 'Comparing evidence', 'Agreement between independent sources can strengthen a claim. Accounts that copy a single source are not independent confirmations.'],
        ],
    },
};
